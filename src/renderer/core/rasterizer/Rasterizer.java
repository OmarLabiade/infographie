...
public class Rasterizer {
    ...
    public void rasterizeFace(final Fragment v1, final Fragment v2, final Fragment v3)
        ...
        // boite englobante du triangle (on teste que sur cette partie)
        ...
        for (int y = ymin; y <= ymax; y++) {
            for (int x = xmin; x <= xmax; x++) {
                ...
                Vector p = new Vector(1, x, y);
                Vector bc = cMat.multiply(p); // coordonnées barycentriques
                ...
                if (a >= 0 && b >= 0 && c >= 0) {
                    ...
                    int n = v1.getNumAttributes();
                    for (int i = 0; i < n; i++) {
                        double val = a * v1.getAttribute(i) + b * v2.getAttribute(i) + c * v3.getAttribute(i);
                        if (i >= 1 && i <= 3) {
                            val = MathUtils.clamp(val, 0., 1.); // 0. couleur noir (0,0,0)rgb ...
                        }

                        frag.setAttribute(i, val);
                    }
